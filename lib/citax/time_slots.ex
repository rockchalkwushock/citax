defmodule App.TimeSlots do
  alias App.Event.Repo, as: EventRepo
  ...
  defp day_start, do: Application.get_env(:citax, :owner)[:day_start]
  defp day_end, do: Application.get_env(:citax, :owner)[:day_end]
