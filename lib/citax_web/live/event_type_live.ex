defmodule AppWeb.EventTypeLive do
  use AppWeb, :live_view

  alias Timex.Duration
  alias AppWeb.Components.EventType

  def mount(%{"event_type_slug" => slug} = _params, _session, socket) do
    case App.get_event_type_by_slug(slug) do
      {:ok, event_type} ->
        socket =
          socket
  ...
  defp assign_time_slots(socket, %{"date" => _}) do
    ...
    time_slots = App.build_time_slots(date, time_zone, event_duration)
